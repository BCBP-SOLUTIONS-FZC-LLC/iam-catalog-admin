...
├── ARCHITECTURE.md  CACHE_DESIGN.md  MIGRATION_RUNBOOK.md  IMPLEMENTATION_GAP_ANALYSIS.md
├── EVENT_COMPATIBILITY_REPORT.md  O_AND_M_DELTA.md  CHANGELOG.md  README.md
